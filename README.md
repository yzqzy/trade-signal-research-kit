...
| 研报中心（静态索引） | — | `output/site/reports/**` → `apps/research-hub/public/reports` | `pnpm run reports-site:emit` → `pnpm run sync:reports-to-app` → 见 [reports-site-publish](docs/guides/reports-site-publish.md) |
