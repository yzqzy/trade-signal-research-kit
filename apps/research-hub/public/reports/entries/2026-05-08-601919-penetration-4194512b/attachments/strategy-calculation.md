...
**一句话结论**：龟龟投资策略 · 选股分析报告：中远海控（601919） — [买入]。

| 指标 | 数值 | 判定 |
|:-----|:-----|:-----|
| Owner Earnings | 18,671.94 百万元 | — |
| 粗算穿透回报率 | 8.69% | 因子2：通过 |
| 精算穿透回报率 | 12.58% | 因子3：通过（外推medium；R−GG=-3.9pct） |
| 门槛值 | 4.50% | — |
| 安全边际 | 8.08 pct | — |
| 价值陷阱风险 | low | — |
| 外推可信度 | medium | — |
...
> - A/B/C: 35,227.98 / 4,359.83 / 30,868.15 百万元
> - D/E/G/I: 10,317.79 / 25,015.55 / 0.90 / 18,671.94
> - M/O/Q: 77.54 / 0.00 / 20.00
> - R vs Rf/II: 8.69% vs 2.50% / 4.50%
> - 结论：通过
...
> - AA/FF/GG/HH: 35,748.11 / 27,018.61 / 12.58% / -3.89
> - 外推可信度：medium
> - 结论：通过
